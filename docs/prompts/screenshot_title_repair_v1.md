...
Use only the entries in `SOURCE_SUPPORTED_TITLE_ANCHORS` below. Preserve
technical identifiers, product names, and numbers exactly as they appear in the
allowlist. Traditional Chinese output must remain Traditional Chinese.
