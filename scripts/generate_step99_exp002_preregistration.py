...
def build_manifest() -> dict:
    ...
    manifest["supersedes"] = {
        ...
        "terminal_status": "aborted_pre_scoring_pgvector_seed_order",
        "tuning_scored": False,
        "decision_scored": False,
        "canonical_result_created": False,
    }
    manifest["artifacts"] = {
        "result_path": "dev_state/artifacts/step_99/step99-exp-002-result.json",
        "pgvector_evidence_path": "dev_state/artifacts/step_99/step99-exp-002-pgvector-evidence.json",
    }
    extra_paths = (
        "scripts/generate_step99_exp002_preregistration.py",
        "tests/evals/step99_hybrid_eval_v2.py",
        "tests/evals/step99_pgvector_gate_v2.py",
...
def main() -> None:
    ...
    if output.exists() or (OUTPUT_DIR / "manifest.sha256").exists():
        raise SystemExit("Step 99 exp-002 preregistration already exists")
