...
from tests.evals.step99_hybrid_eval_v3 import DEFAULT_FIXTURE_DIR, EXPERIMENT_ID
from tests.evals.step99_pgvector_gate_v2 import _seed_ordered
...
def main() -> None:
    _activate_contract()
    parser = argparse.ArgumentParser(description="Guarded Step 99 exp-003 disposable pgvector gate")
